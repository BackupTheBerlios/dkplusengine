 ...
 * @version    $Id: AlnumUnderline.php,v 1.1 2009/12/29 18:12:06 dkplus Exp $
 */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Dkplus_Validate_AlnumUnderline extends Zend_Validate_Abstract
{
    /**
	 ...
	 * @var boolean
	 */
	protected $_meansEnglishAlphabet = false;
	 ...
	 *
	 * @param boolean $value
	 * @return Dkplus_Validate_AlnumUnderline
	 */
	public function setMeansEnglishAlphabet($value){
		$this->_meansEnglishAlphabet = (boolean) $value;
		return $this;
	}
