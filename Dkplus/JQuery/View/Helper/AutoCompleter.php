 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
  */
class Dkplus_JQuery_View_Helper_AutoCompleter extends Dkplus_JQuery_View_Helper_JsCssLoader
{
    /**
     ...
     * @return String
     */
	public function autoCompleter($id, $value = null, array $params = array(), array $attribs = array())
	{
        $attribs = $this->_prepareAttributes($id, $value, $attribs);

        if(!isset($params['data']) && !isset($params['url'])) {
           ////require_once "ZendX/JQuery/Exception.php";
            throw new ZendX_JQuery_Exception("Cannot construct AutoCompleter field without specifying Parameters Data and Url");
        }
