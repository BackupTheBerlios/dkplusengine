 ...
 * @version     $Id: AnotherMultiSelect.php,v 1.1 2009/12/29 18:12:03 dkplus Exp $
 */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
  */
class Dkplus_JQuery_View_Helper_AnotherMultiSelect extends Dkplus_JQuery_View_Helper_JsCssLoader
{
    /**
     ...
     * @return String
     */
	public function anotherMultiSelect($id, $value = null, array $params = array(), array $attribs = array())
	{
        $attribs = $this->_prepareAttributes($id, $value, $attribs);

		$translateParams = array('removeLabel', 'highlightAddedLabel', 'highlightRemovedLabel');
		foreach($translateParams AS $param){
			if(
				isset($params[$param])
			){
				$params[$param] = Zend_Layout::getMvcInstance()
					->getView()->translate($params[$param]);
			}
		}

        $params = ZendX_JQuery::encodeJson($params);

        $js = sprintf('%s("#%s").asmSelect(%s);',
