 ...
 * @version    $Id: VisibleMenu.php,v 1.1 2009/12/29 18:12:07 dkplus Exp $
 */

/**
 * @see Zend_View_Helper_Navigation_HelperAbstract
 */
//require-once 'Zend/View/Helper/Navigation/HelperAbstract.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Dkplus_View_Helper_Navigation_VisibleMenu
...
/**
                                   ...
                                   $expandBranch)
    {
        ...
        foreach ($iterator as $page) {			
            ...
            if ($depth < $minDepth || !$this->accept($page)) {
				...
				//page in first displayed level
				if(
					$page->getParent()->isActive(true)
				){
					$accept = true;
				}
                                  ...
                                  $partial = null)
    {
        ...
        if (empty($partial)) {
            //require-once 'Zend/View/Exception.php';
